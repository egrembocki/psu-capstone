...
<<<<<<< HEAD:SDR_Encoder_Temp/Sdr_old_probably_drop.py
...
=======
    def set_sparse_in_place(self):
        pass

    def set_coordinates_in_place(self):
>>>>>>> origin/main:src/psu_capstone/sdr_encoder_temp/sdr_old_probably_drop.py
        pass
...
=======
    def set_dense(self, dense: List[int] | np.ndarray):
        pass

    def get_dense(self) -> list[Any]:
>>>>>>> origin/main:src/psu_capstone/sdr_encoder_temp/sdr_old_probably_drop.py
        return self.dense_
...
=======
    def set_sparse(self, value: List[int]):
        pass

    def get_sparse(self) -> List[int]:
        return self.sparse_

    def set_coordinates(self, coordinates: List[List[int]]):
        pass

    def get_coordinates(self) -> List[List[int]]:
        return self.coordinates_

    def set_sdr(self, value: "SparseDistributedRepresentation"):
>>>>>>> origin/main:src/psu_capstone/sdr_encoder_temp/sdr_old_probably_drop.py
...
=======
    def get_overlap(self, sdr: "SparseDistributedRepresentation") -> int:
>>>>>>> origin/main:src/psu_capstone/sdr_encoder_temp/sdr_old_probably_drop.py
...
=======
    ...
    def kill_cells(self, fraction: float, seed: int):
>>>>>>> origin/main:src/psu_capstone/sdr_encoder_temp/sdr_old_probably_drop.py
        if not 0 <= fraction <= 1:
...
=======
    def add_destroy_callback(self, callback: Callable):
>>>>>>> origin/main:src/psu_capstone/sdr_encoder_temp/sdr_old_probably_drop.py
...
=======
    def remove_destroy_callback(self, index: int):
